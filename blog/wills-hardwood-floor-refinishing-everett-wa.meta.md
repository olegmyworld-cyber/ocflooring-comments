...
| Field | Value |
|---|---|
| **Name (H1)** | Hardwood Floor Refinishing in Everett, WA: 2026 Cost, Calculator & Honest Answers |
| **Slug** | `hardwood-floor-refinishing-everett-wa` |
| **Title Tag** (58 chars) | Hardwood Floor Refinishing Everett, WA \| 2026 Cost & Guide |
...
| Fact | Value | Source |
|---|---|---|
| Phone | (425) 350-4435 | Wills Flooring listings |
| Address | 2109 196th St SW #106, Lynnwood, WA 98036 | Wills Flooring listings |
| Since | 2013 (12+ years) | willsflooring.com |
| Credentials | Bona Certified Craftsmen | willsflooring.com |
| Reviews | 4.8 stars, 100+ five-star Google reviews | willsflooring.com |
| Minimum | 500 sq ft | willsflooring.com cost page |
| Pricing | $1.99 recoat / $3.99 natural / $6.50 stain, stairs $55–$75 per tread, dust +$250, W&D +$160, appliances +$80 | Confirmed by Oleg 2026-09-15 (same as OC Flooring) |
| Warranty | 1-year workmanship | Confirmed by Oleg 2026-09-15 |

## Internal links used (Wills URL structure)

- `/everett-flooring-services/hardwood-floor-refinishing-in-everett-wa-wills-flooring`
- `/services/floor-refinish`, `/services/hardwood-flooring`, `/services/process`
- `/flooring-installation-cost`, `/contact`, `/about`
- `/mukilteo-flooring-services/hardwood-floor-refinishing-in-mukilteo-wa-wills-flooring`
- `/marysville-flooring-services/hardwood-floor-refinishing-in-marysville-wa-wills-flooring`
- `/lake-stevens-flooring-services/hardwood-floor-refinishing-in-lake-stevens-wa-wills-flooring`
- `/lynnwood-wa-flooring-services/hardwood-floor-refinishing-in-lynnwood-wa-wills-flooring`

## Design note

Themed to Wills Flooring's Webflow variables: Primary Blue `hsl(216 73% 10%)` = `#071730` (buttons, headings, CTA gradient) and Primary Gold `#ea8a2a` (eyebrows, checkmarks, icons, review link). Tokens live in the first `<style>` block as `--brand`, `--brand2`, `--gold`.

## Structured data

`@graph` with **BlogPosting** (Wills Flooring author/publisher, contentLocation Everett), **Service** (provider Wills Flooring with Lynnwood PostalAddress, areaServed Everett + 7 cities, three priced Offers), **FAQPage** (13 questions).
