// OC Flooring — carpet installation page bundle: "ocCarpetBellevue" v1.4.1
...
// Placeholders on the native photo-quote form (the settings API reserves the
// placeholder attribute, so they are applied at runtime).
(function(){
function ph(sel,t){var e=document.querySelector(sel);if(e&&!e.placeholder)e.placeholder=t}
ph('.ci-pq-mount input#name','Jordan Alvarez');
ph('.ci-pq-mount input#email','you@email.com \u2014 where your written price goes');
ph('.ci-pq-mount #pq-phone','(425) 555-0148');
ph('.ci-pq-mount #pq-notes','Example: Ripples in two bedrooms and the hallway, about 600 sq ft, plus 13 stairs. Want a price for stretching vs replacing with mid-grade carpet.');
})();
