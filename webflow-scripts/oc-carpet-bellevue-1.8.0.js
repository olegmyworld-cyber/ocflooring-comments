// OC Flooring — carpet installation city pages bundle: "ocCarpetBellevue" v1.8.0
// Pages: /city-of-*/carpet-installation-in-<city>-wa (all carpet city pages;
// originally built for Bellevue, page id 6a8ccb1ebf28596111eed9f2)
...
// v1.6.1: the section header (eyebrow, h2, lead) is now server-rendered by an
// HTML embed on the page (crawler/AI-search visible); the bundle fills the
// embed's #ocpq-shell with the interactive interior, or renders the whole
// section as a fallback when the embed is absent.
// v1.7.0: decorative stroke-icon layer across the text-heavy sections.
// v1.8.0: city-agnostic — the estimator's ballpark label derives the city
// from the URL slug (carpet-installation-in-<city>-wa), and on pages that
// include the shared "Proudly Serving" areas slider the Carpet Installation
// slide is moved to the front (same technique as the site's OCAreasStart).
(function(){
...
h+='</div></div></div><div class="es-sum"><div class="es-sumlab">Your '+CITYN+' ballpark</div>'
...
}else if(!sec.querySelector('#ocpq-form')){
var shell=document.getElementById('ocpq-shell')||sec.querySelector('.ocpq-wrap');
if(shell)shell.innerHTML="<div class=\"ocpq-card\"><div id=\"ocpq-form\"><div class=\"ocpq-drop\" id=\"ocpq-drop\" role=\"button\" tabindex=\"0\"><div class=\"ocpq-dropicon\"><svg aria-hidden=\"true\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 16V4\"/><path d=\"m7 9 5-5 5 5\"/><path d=\"M4 16v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2\"/></svg></div><div class=\"ocpq-droptitle\">Drag your photos here, or tap to browse</div><div class=\"ocpq-dropsub\">Even one photo helps. Three is ideal: a close-up of the worst spot, one from a few feet back, and one of the whole room. Up to 8 &middot; JPG, PNG or HEIC.</div></div><div class=\"ocpq-btnrow\"><button type=\"button\" class=\"ocpq-ghost\" id=\"ocpq-browse\"><svg aria-hidden=\"true\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-4l-2-2h-4L8 6H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2Z\"/><circle cx=\"12\" cy=\"13\" r=\"3.2\"/></svg>Choose from device</button><button type=\"button\" class=\"ocpq-ghost\" id=\"ocpq-camera\"><svg aria-hidden=\"true\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"2\" y=\"7\" width=\"20\" height=\"14\" rx=\"2\"/><path d=\"M8 7 9.5 4h5L16 7\"/><circle cx=\"12\" cy=\"14\" r=\"3.4\"/></svg>Take a photo now</button></div><div class=\"ocpq-hint\" id=\"ocpq-emptyhint\"><svg aria-hidden=\"true\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 5v14\"/><path d=\"m6 13 6 6 6-6\"/></svg>Add a photo and we'll ask for your name, email and phone next \u2014 two more taps.</div><div class=\"ocpq-working\" id=\"ocpq-working\" role=\"status\" aria-live=\"polite\" hidden></div><input type=\"file\" id=\"ocpq-file\" accept=\"image/*\" multiple hidden><input type=\"file\" id=\"ocpq-cam\" accept=\"image/*\" capture=\"environment\" hidden><div id=\"ocpq-gallery\" hidden><div class=\"ocpq-galhead\"><div class=\"ocpq-count\" id=\"ocpq-count\"></div><div class=\"ocpq-need\" id=\"ocpq-need\"></div></div><div class=\"ocpq-grid\" id=\"ocpq-thumbs\"></div><div class=\"ocpq-nopreview\" id=\"ocpq-nopreview\" hidden></div></div><div class=\"ocpq-err\" id=\"ocpq-photoerr\" role=\"alert\" aria-live=\"assertive\" hidden></div><div id=\"ocpq-reveal\" hidden><div class=\"ocpq-block\"><div class=\"ocpq-blockhead\"><div class=\"ocpq-blocktitle\">What's going on with the carpet?</div><div class=\"ocpq-blocksub\">Pick everything that applies \u2014 it tells us what to look for in your photos.</div></div><div class=\"ocpq-chips\" id=\"ocpq-chips\"><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Ripples &amp; waves</button><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Matted traffic paths</button><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Pet damage or odor</button><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Seams splitting or fraying</button><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Stairs &amp; landings</button><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Water damage</button><button type=\"button\" class=\"ocpq-chip\" aria-pressed=\"false\">Not sure \u2014 you tell me</button></div></div><div class=\"ocpq-block\"><div class=\"ocpq-blockhead\"><div class=\"ocpq-blocktitle\">Tell us about it in your own words</div><div class=\"ocpq-blocksub\">Optional \u2014 how many rooms, when it started, whether you already have carpet picked out. Whatever you think we should know.</div></div><textarea id=\"ocpq-notes\" class=\"ocpq-textarea\" rows=\"4\" maxlength=\"2000\" placeholder=\"Example: The carpet in two bedrooms and the hallway is rippling near the doors. About 600 sq ft total. We also have 13 stairs. Would like a price for stretching vs replacing with mid-grade carpet.\"></textarea></div><div class=\"ocpq-block\"><div class=\"ocpq-blocktitle\">Where should the quote go?</div><div class=\"ocpq-fields\"><label class=\"ocpq-field\"><span>Full name</span><input type=\"text\" id=\"ocpq-name\" placeholder=\"Jordan Alvarez\" autocomplete=\"name\"></label><label class=\"ocpq-field\"><span>Email</span><input type=\"email\" id=\"ocpq-email\" placeholder=\"you@email.com\" autocomplete=\"email\" inputmode=\"email\"></label><label class=\"ocpq-field\"><span>Phone</span><input type=\"tel\" id=\"ocpq-phone\" placeholder=\"(425) 555-0148\" autocomplete=\"tel\" inputmode=\"tel\"></label></div></div><div class=\"ocpq-err\" id=\"ocpq-formerr\" role=\"alert\" aria-live=\"assertive\" hidden></div><div class=\"ocpq-submitrow\"><button type=\"button\" class=\"ocpq-submit\" id=\"ocpq-submit\">Send photos &amp; get my quote</button><div class=\"ocpq-note\">Sent before 3pm on a weekday? Your price lands today. After that, first thing next morning.</div></div></div><div id=\"ocpq-done\" hidden><div class=\"ocpq-donetop\"><div class=\"ocpq-check\"><svg aria-hidden=\"true\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2.4\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m4 12.5 5 5L20 6.5\"/></svg></div><div><h3 id=\"ocpq-donehead\"></h3><p id=\"ocpq-donebody\"></p></div></div><div class=\"ocpq-next\"><div class=\"ocpq-nexttag\">What happens next</div><div class=\"ocpq-step\"><span>1</span><div><b>An estimator opens your photos</b><i>Not an algorithm \u2014 the same person who would have walked your carpet in person.</i></div></div><div class=\"ocpq-step\"><span>2</span><div><b>You get a written price by email</b><i>Stretch or replace, itemized \u2014 what it costs and how long we need in your home.</i></div></div><div class=\"ocpq-step\"><span>3</span><div><b>Only then do you decide</b><i>Reply to book a date, ask a question, or ignore it entirely. No follow-up sales calls.</i></div></div></div><div class=\"ocpq-donebtns\"><a class=\"ocpq-call\" href=\"tel:+14255951079\">Call (425) 595-1079</a><button type=\"button\" class=\"ocpq-ghost\" id=\"ocpq-reset\">Send another room</button></div></div></div><div class=\"ocpq-promise\"><div><b>Same day</b><span>A written price in your inbox, not a callback</span></div><div><b>A person, not a bot</b><span>Every photo reviewed by one of our estimators</span></div><div><b>No obligation</b><span>Licensed and insured &middot; 1-year workmanship warranty</span></div></div>";
}
...
// Decorative icon layer — hand-drawn stroke icons matched to each card's
// meaning across the text-heavy sections (trust bar, hook stats, steps,
// price cards, extras, pads, stretch-vs-replace, areas, CTA buttons).
// Purely decorative (aria-hidden), keyword-matched so reordered or edited
// cards keep sensible icons; idempotent per host element.
(function(){
var P={"home": "<path d=\"m3 11 9-7 9 7\"/><path d=\"M5 9.5V20h14V9.5\"/><path d=\"M10 20v-5h4v5\"/>", "shield": "<path d=\"M12 3 5 5.8v5.4c0 4.4 2.9 7.5 7 8.8 4.1-1.3 7-4.4 7-8.8V5.8Z\"/><path d=\"m9 11.6 2.1 2.1 3.9-4.1\"/>", "van": "<path d=\"M2 16V8a1 1 0 0 1 1-1h10v9\"/><path d=\"M13 10h4.2L21 13.4V16h-2\"/><circle cx=\"7\" cy=\"17.4\" r=\"1.7\"/><circle cx=\"16.6\" cy=\"17.4\" r=\"1.7\"/><path d=\"M8.7 17.4h6.2\"/><path d=\"M2 16h3.3\"/>", "tag": "<path d=\"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z\"/><circle cx=\"7.5\" cy=\"7.5\" r=\"1.4\"/>", "clock": "<circle cx=\"12\" cy=\"12\" r=\"8.5\"/><path d=\"M12 7.2v4.8l3.1 1.9\"/>", "calendar": "<rect x=\"3.5\" y=\"4.8\" width=\"17\" height=\"15.7\" rx=\"2\"/><path d=\"M8 2.8v4M16 2.8v4M3.5 10.3h17\"/>", "clipboard": "<rect x=\"4.5\" y=\"4\" width=\"15\" height=\"17.5\" rx=\"2\"/><path d=\"M9 2.5h6V6H9z\"/><path d=\"M8.5 11h7M8.5 14.5h7M8.5 18h4\"/>", "housecheck": "<path d=\"m3 11 9-7 9 7\"/><path d=\"M5 9.5V20h14V9.5\"/><path d=\"m9.3 14.6 2.1 2.1 3.8-4\"/>", "layers": "<path d=\"m12 4 9 5-9 5-9-5 9-5Z\"/><path d=\"m3 14.5 9 5 9-5\"/>", "roll": "<circle cx=\"7.2\" cy=\"9\" r=\"4.6\"/><circle cx=\"7.2\" cy=\"9\" r=\"1.4\"/><path d=\"M7.2 13.6H21\"/><path d=\"M21 13.6V9h-9.2\"/>", "stairs": "<path d=\"M3 20h4.5v-4H12v-4h4.5V8H21\"/><path d=\"M21 8V4\"/>", "stretch": "<path d=\"M7.5 12H2.5\"/><path d=\"m5 9.5-2.5 2.5L5 14.5\"/><path d=\"M16.5 12h5\"/><path d=\"m19 9.5 2.5 2.5L19 14.5\"/><rect x=\"9.7\" y=\"9.7\" width=\"4.6\" height=\"4.6\" rx=\"1.2\"/>", "swap": "<path d=\"M7 8.5h11\"/><path d=\"m14.8 5.3 3.2 3.2-3.2 3.2\"/><path d=\"M17 15.5H6\"/><path d=\"m9.2 12.3-3.2 3.2 3.2 3.2\"/>", "pin": "<path d=\"M12 21.5S5 16 5 10.3a7 7 0 0 1 14 0C19 16 12 21.5 12 21.5Z\"/><circle cx=\"12\" cy=\"10.3\" r=\"2.6\"/>", "phone": "<path d=\"M5.2 3.8h3.6L10.4 8l-2.1 1.6a12.8 12.8 0 0 0 6.1 6.1L16 13.6l4.2 1.6v3.6a1.9 1.9 0 0 1-2.1 1.9A16.8 16.8 0 0 1 3.3 5.9a1.9 1.9 0 0 1 1.9-2.1Z\"/>", "camera": "<rect x=\"2.5\" y=\"7\" width=\"19\" height=\"13.5\" rx=\"2\"/><path d=\"M8.3 7 9.7 4.2h4.6L15.7 7\"/><circle cx=\"12\" cy=\"13.6\" r=\"3.3\"/>", "paw": "<circle cx=\"8.2\" cy=\"6.8\" r=\"1.7\"/><circle cx=\"15.8\" cy=\"6.8\" r=\"1.7\"/><circle cx=\"4.9\" cy=\"10.8\" r=\"1.6\"/><circle cx=\"19.1\" cy=\"10.8\" r=\"1.6\"/><path d=\"M12 10.8c-2.7 0-5 2.1-5.3 4.7-.2 1.7 1.1 3.3 2.8 3.3 1 0 1.6-.5 2.5-.5s1.5.5 2.5.5c1.7 0 3-1.6 2.8-3.3-.3-2.6-2.6-4.7-5.3-4.7Z\"/>", "sofa": "<path d=\"M5.5 11V8.2a2.7 2.7 0 0 1 2.7-2.7h7.6a2.7 2.7 0 0 1 2.7 2.7V11\"/><path d=\"M3 13.4a1.9 1.9 0 0 1 3.8 0v1.2h10.4v-1.2a1.9 1.9 0 0 1 3.8 0v3.2a1.9 1.9 0 0 1-1.9 1.9H4.9A1.9 1.9 0 0 1 3 16.6Z\"/><path d=\"M5.3 18.5v1.7M18.7 18.5v1.7\"/>", "star": "<path d=\"m12 4.2 2.3 4.8 5.3.7-3.9 3.7.9 5.2L12 16.2l-4.6 2.4.9-5.2-3.9-3.7 5.3-.7Z\"/>", "check": "<path d=\"m5.5 12.5 4.3 4.3 8.7-9.3\"/>"};
...
for(var i=0;i<host.children.length;i++)if((' '+host.children[i].className+' ').indexOf(' ci-ico ')>-1)return;
var s=document.createElement('span');s.className='ci-ico'+(cls?' '+cls:'');
...
function deco(){
if(!document.getElementById('ci-ico-css')){
var st=document.createElement('style');st.id='ci-ico-css';
st.textContent=".ci-ico{display:inline-grid;place-items:center;background:#F5EDE4;color:#8F4F3C;border-radius:12px;width:40px;height:40px;flex:0 0 auto}\n.ci-ico svg{width:20px;height:20px;display:block}\n.ci-price-card>.ci-ico,.ci-sr-card>.ci-ico,.ci-mini-card>.ci-ico{margin-bottom:14px}\n.ci-ico-stat{width:42px;height:42px;background:#F7F2EC;align-self:center;margin-right:4px}\n.ci-ico-inl{width:27px;height:27px;border-radius:9px;margin-right:9px;vertical-align:-8px}\n.ci-ico-inl svg{width:15px;height:15px}\n.ci-ico-mini{width:20px;height:20px;border-radius:0;background:transparent;color:inherit;margin-right:6px;vertical-align:-4px}\n.ci-ico-mini svg{width:14px;height:14px}\n.ci-step-card{position:relative}\n.ci-ico-step{position:absolute;top:20px;right:20px;background:#F7F2EC}\n.ci-ico-btn{width:auto;height:auto;background:transparent;color:inherit;border-radius:0;margin-right:9px;vertical-align:-4px}\n.ci-ico-btn svg{width:18px;height:18px}";
document.head.appendChild(st)}
chip(document.querySelector('.ci-trust-mid .ci-trust-strong'),'home','ci-ico-inl');
chip(document.querySelector('.ci-trust-right .ci-trust-strong'),'shield','ci-ico-inl');
all('.ci-hook-stat').forEach(function(s){var t=txt(s);
chip(s,/visit/.test(t)?'van':(/day/.test(t)?'clock':'tag'),'ci-ico-stat')});
var STEPS=['calendar','van','clipboard','housecheck'];
all('.ci-step-card').forEach(function(c,i){chip(c,STEPS[i]||'check','ci-ico-step')});
all('.ci-price-card').forEach(function(c){var t=txt(c.querySelector('.ci-price-h'));
chip(c,/stair/.test(t)?'stairs':(/stretch|repair/.test(t)?'stretch':(/supplied|pad/.test(t)?'layers':'roll')))});
all('.ci-mini-card').forEach(function(c){var t=txt(c.querySelector('.ci-mini-h'));
chip(c,/haul|removal/.test(t)?'van':(/furniture/.test(t)?'sofa':(/pet/.test(t)?'paw':'check')))});
all('.ci-pad-tile .ci-tile-label').forEach(function(l){var t=txt(l);
chip(l,/pet|kid/.test(t)?'paw':(/recommend/.test(t)?'star':'check'),'ci-ico-mini')});
all('.ci-sr-card').forEach(function(c){
chip(c,/replace/.test(txt(c.querySelector('.ci-sr-h')))?'swap':'stretch')});
all('.ci-areas-h3').forEach(function(h){chip(h,'pin','ci-ico-inl')});
all('.ci-cta a').forEach(function(a){var href=a.getAttribute('href')||'';
if(href.indexOf('tel:')===0)chip(a,'phone','ci-ico-btn');
else if((' '+a.className+' ').indexOf('ci-btn-primary')>-1)chip(a,'calendar','ci-ico-btn')});
chip(document.querySelector('.ci-upload-btn'),'camera','ci-ico-btn');
}
function run(){try{deco()}catch(e){}}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',run);else run();
window.addEventListener('load',run);
})();
// Promote the Carpet Installation slide in the shared areas slider (parity
...
if(h&&h.textContent.replace(/\s+/g,' ').trim().toLowerCase()==='carpet installation service areas'){
